...
var BlobUploader = /** @class */ (function () {
    ...
    BlobUploader.prototype.uploadToBlob = function (blobInfo, stream, streamLength, done) {
        ...
        azure_iot_common_2.tripleValueCallbackToPromise(function (_callback) {
            ...
            var pipeline = _this.storageApi.StorageURL.newPipeline(new _this.storageApi.AnonymousCredential(), {
            ...
            var blockBlobURL = new _this.storageApi.BlockBlobURL("https://" + blobInfo.hostName + "/" + blobInfo.containerName + "/" + blobInfo.blobName + blobInfo.sasToken, pipeline);
            var uploadPromise = _this.storageApi.uploadStreamToBlockBlob(_this.storageApi.Aborter.timeout(30 * 60 * 1000), stream, blockBlobURL, streamLength, 20);
            uploadPromise
